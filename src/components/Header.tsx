...
export function Header({ tonUsd }: { tonUsd: number }) {
  return (
    <header className="fixed inset-x-0 top-0 z-40 border-b border-god-border/70 bg-god-bg/85 backdrop-blur-xl">
      <div className="container-app flex h-[58px] items-center justify-between pt-[var(--safe-top)]">
